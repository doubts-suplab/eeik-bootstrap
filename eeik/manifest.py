...
Usage:
    eeik validate                        # auto-detects manifest
    eeik validate path/to/manifest.yaml  # explicit path
    eeik validate --strict               # treat warnings as errors
"""
...
# Canonical manifest schema — the single source of truth, shipped with the engine package.
SCHEMA_FILE  = PKG_DIR / "schemas" / "manifest.schema.json"
