...
index), `eeik verify` (conformance gate, ADR-008), `eeik contract` (emit a HALO Agent Contract, ADR-009),
`eeik mcp` (read-model MCP server, ADR-006), `eeik run <gen> --governed`.
